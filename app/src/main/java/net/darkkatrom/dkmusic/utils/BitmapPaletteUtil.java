...
/*
 * This is a copy from 'BitmapWithColors' by CyanogenMod/LineageOS:
 * https://github.com/LineageOS/android_packages_apps_Eleven/blob/lineage-16.0/src/org/lineageos/eleven/utils/BitmapWithColors.java
 * 
 * Changes:
 * - Removed caching
 */
public class BitmapPaletteUtil {
    ...
    public BitmapPaletteUtil(Bitmap bitmap) {
        mBitmap = bitmap;
    ...
    public BitmapPaletteUtil(Bitmap bitmap, int vibrantColor, int vibrantDarkColor) {
        mBitmap = bitmap;
    ...
    @Override
    public String toString() {
        return "BitmapPaletteUtil[colors=" + mColors + "]";
    }
}
